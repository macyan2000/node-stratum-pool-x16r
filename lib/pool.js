...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    function DetectCoinData(finishedCallback){
        ...
        _this.daemon.batchCmd(batchRpcCalls, function(error, results){
            ...
            if (options.coin.name == 'neetcoin') {
                options.initStats = {
                    connections: rpcResults.getnetworkinfo.connections,
                    difficulty: rpcResults.getmininginfo.difficulty['proof-of-work'] * algos[options.coin.algorithm].multiplier,
                    networkHashRate: + rpcResults.getmininginfo.netmhashps * 1000 * 1000
                };
            } else {
                options.initStats = {
                    connections: rpcResults.getnetworkinfo.connections,
